...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ElegantExtensions.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Giancarlo Buenaflor/ElegantExtensions'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Giancarlo Buenaflor' => 'giancarlo.buenaflor@yahoo.com' }
  s.source           = { :git => 'https://github.com/Giancarlo Buenaflor/ElegantExtensions.git', :tag => s.version.to_s }
